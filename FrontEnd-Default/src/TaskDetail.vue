...
const task = reactive(
  prop.taskDetail.value != null ? prop.taskDetail.value : {}
)
...
const handleClick = async () => {
  ...
  const addTaskDetail = {
    title:
      formatedTask.value.taskTitle.length > 0
        ? formatedTask.value.taskTitle
        : null,
    assignees:
      formatedTask.value.taskAssignees.length > 0
        ? formatedTask.value.taskAssignees
        : null,
    description:
      formatedTask.value.taskDescription.length > 0
        ? formatedTask.value.taskDescription
        : null,
    status:
      formatedTask.value.taskStatus != null
        ? formatedTask.value.taskStatus
        : 'NO_STATUS'
  }
  if (prop.operate == 'add') {
      ...
      <div class="flex flex-col justify-between bg-white p-4">
        <div class="itbkk-title w-full h-[10%] mt-2">
          <textarea
            ...
            v-model.trim="formatedTask.taskTitle"
          >
          </textarea>
        </div>
          ...
          <div class="w-[70%] h-[50%]">
            ...
            <div class="w-full h-[420px]">
              <textarea
                ...
                :class="
                  formatedTask.taskDescription == null
            ...
            <div class="h-[180px]">
              ...
              <div class="h-[150px]">
                <textarea
                  ...
                  :class="
                    formatedTask.taskAssignees == null
                      ? 'italic text-gray-500 '
                      : ''
                  "
