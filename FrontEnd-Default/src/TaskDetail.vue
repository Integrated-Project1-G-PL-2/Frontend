...
<template>
  <div
    class="bg-grey-500 backdrop-blur-sm w-screen text-wrap fixed top-0 left-0 pt-[100px] h-screen"
  >
    <div class="w-[90%] m-[auto]">
      <div class="flex flex-col justify-between bg-white p-4">
        ...
        <div class="flex flex-row w-full justify-end border-t">
          <button
            class="itbkk-button bg-green-400 scr-m:btn-sm scr-l:btn-md scr-l:rounded-[10px] rounded-[2px] w-[50px] h-[25px] font-sans btn-xs scr-l:btn-m text-wrap text-center flex flex-col gap-2 hover:text-gray-200 mr-3 mt-2"
          >
            <div class="btn text-center">Ok</div>
          </button>
          <button
            class="itbkk-button bg-gray-400 scr-m:btn-sm scr-l:btn-md scr-l:rounded-[10px] rounded-[2px] w-[50px] h-[25px] font-sans btn-xs scr-l:btn-m text-wrap text-center flex flex-col gap-2 hover:text-gray-200 mr-3 mt-2"
          >
            <div class="btn text-center" @click="$emit('closePopUp', false)">
              Close
            </div>
          </button>
        </div>
